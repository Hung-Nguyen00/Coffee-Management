...
from rest_framework.exceptions import NotAuthenticated, ParseError, PermissionDenied, ValidationError
...
def try_parse_validation_error(exc: Exception) -> GenericException:
    ...
    if isinstance(exc, ValidationError):
        ...
        return PermissionDeniedException(message=exc.detail, status_code=exc.status_code)
